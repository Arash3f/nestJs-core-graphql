...
readUsers?: [{	where?: ValueTypes["ReadUserInput"] | undefined | null | Variable<any, string>,	pagination?: ValueTypes["PaginationData"] | undefined | null | Variable<any, string>,	sortBy?: ValueTypes["SortByData"] | undefined | null | Variable<any, string>},ValueTypes["ReadUserOutput"]],
...
updateUser?: [{	data: ValueTypes["UpdateUserInput"] | Variable<any, string>,	where: ValueTypes["IdInput"] | Variable<any, string>},ValueTypes["UserModel"]],
deleteUser?: [{	where: ValueTypes["IdInput"] | Variable<any, string>},ValueTypes["SuccessOtput"]],
changePassword?: [{	data: ValueTypes["ChangePasswordInput"] | Variable<any, string>,	where: ValueTypes["IdInput"] | Variable<any, string>},ValueTypes["SuccessOtput"]],
		__typename?: boolean | `@${string}`
}>;
...
readUsers?: [{	where?: ResolverInputTypes["ReadUserInput"] | undefined | null,	pagination?: ResolverInputTypes["PaginationData"] | undefined | null,	sortBy?: ResolverInputTypes["SortByData"] | undefined | null},ResolverInputTypes["ReadUserOutput"]],
		__typename?: boolean | `@${string}`
}>;
	["UserModel"]: AliasType<{
	id?:boolean | `@${string}`,
...
updateUser?: [{	data: ResolverInputTypes["UpdateUserInput"],	where: ResolverInputTypes["IdInput"]},ResolverInputTypes["UserModel"]],
deleteUser?: [{	where: ResolverInputTypes["IdInput"]},ResolverInputTypes["SuccessOtput"]],
changePassword?: [{	data: ResolverInputTypes["ChangePasswordInput"],	where: ResolverInputTypes["IdInput"]},ResolverInputTypes["SuccessOtput"]],
		__typename?: boolean | `@${string}`
}>;
	["LoginOutput"]: AliasType<{
	jwt?:boolean | `@${string}`,
...
["DateTime"]:any;
	...
	deleteUser: ModelTypes["SuccessOtput"],
	changePassword: ModelTypes["SuccessOtput"]
};
	["LoginOutput"]: {
		jwt: string
};
...
["DateTime"]: "scalar" & { name: "DateTime" };
	...
	deleteUser: GraphQLTypes["SuccessOtput"],
	changePassword: GraphQLTypes["SuccessOtput"]
};
	["LoginOutput"]: {
...
type ZEUS_VARIABLES = {
	...
	["ReadUserInput"]: ValueTypes["ReadUserInput"];
